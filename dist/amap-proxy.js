(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["AmapProxy"] = factory();
	else
		root["AmapProxy"] = factory();
})(self, function() {
...
/* harmony export */   "default": function() { return /* binding */ ap; }
/* harmony export */ });
...
var windowWrapper = function windowWrapper(win, convertUrl) {
  if (win.Blob) {
    ...
    win.Blob = function Blob(buffer, options) {
      ...
      return new (Function.prototype.bind.apply(BlobWrapper, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context = [null, injectCode ? _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context2 = ["(" + windowWrapper.toString() + ")(self, " + convertUrl.toString() + ");\n"]).call(_context2, buffer) : buffer, options]).call(_context, args)))();
    };
  }
  if (win.Request) {
    ...
    win.Request = function Request(url) {
      ...
      return new (Function.prototype.bind.apply(RequestWrapper, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context3 = [null, typeof url === 'string' ? convertUrl(url) : url]).call(_context3, args)))();
    };
  }
  if (win.fetch) {
    ...
    win.fetch = function fetch(url) {
      ...
      return fetchWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context4 = [typeof url === 'string' ? convertUrl(url) : url]).call(_context4, args));
    };
  }
  if (win.XMLHttpRequest) {
    ...
    win.XMLHttpRequest.prototype.open = function open(type, url) {
      ...
      return openWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context5 = [type, convertUrl(url)]).call(_context5, args));
    };
  }
};
var documentWrapper = function documentWrapper(win, convertUrl) {
  if (win.document) {
    if (win.document.write) {
      ...
      win.document.write = function write() {
        ...
        return writeWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_map__WEBPACK_IMPORTED_MODULE_2___default()(args).call(args, function (value) {
    ...
    if (typeof document.createTextNode === 'function') {
      ...
      win.document.createTextNode = function createTextNode(data) {
        ...
        return createTextNodeWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context6 = [convertUrl(data)]).call(_context6, args));
      };
    }
  }
  if (win.Element) {
    ...
    win.Element.prototype.setAttribute = function setAttribute(name, value) {
      ...
      if (name === 'src' || name === 'href' || name === 'style') {
        var _context7;
        return setAttributeWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context7 = [name, convertUrl(value)]).call(_context7, args));
      }
      return setAttributeWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context8 = [name, value]).call(_context8, args));
    };
    ...
    win.Element.prototype.setAttributeNS = function setAttributeNS(ns, name, value) {
      ...
      if (name === 'src' || name === 'href' || name === 'style') {
        var _context9;
        return setAttributeNSWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context9 = [ns, name, convertUrl(value)]).call(_context9, args));
      }
      return setAttributeNSWrapper.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context10 = [ns, name, value]).call(_context10, args));
    };
  }
  if (win.HTMLElement) {
    var style = _babel_runtime_corejs3_core_js_object_get_own_property_descriptor__WEBPACK_IMPORTED_MODULE_3___default()(win.HTMLElement.prototype, 'style');
    if (style) {
      Object.defineProperty(win.HTMLElement.prototype, 'style', (0,_babel_runtime_corejs3_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, style, {
        set: function set(value) {
          ...
          if (style.set) {
            ...
            style.set.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context11 = [value]).call(_context11, args));
          }
        }
      }));
    }
  ...
  if (win.HTMLStyleElement) {
    var styleSheet = _babel_runtime_corejs3_core_js_object_get_own_property_descriptor__WEBPACK_IMPORTED_MODULE_3___default()(win.HTMLStyleElement.prototype, 'styleSheet');
    if (styleSheet) {
      Object.defineProperty(win.HTMLStyleElement.prototype, 'styleSheet', (0,_babel_runtime_corejs3_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, styleSheet, {
        set: function set(value) {
          if (value.cssText) {
            value.cssText = convertUrl(value.cssText);
          }
          if (styleSheet.set) {
            ...
            styleSheet.set.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context12 = [value]).call(_context12, args));
          }
        }
      }));
    }
    ...
    element.forEach(function (el) {
      if (win[el]) {
        ...
        property.forEach(function (py) {
          var descriptor = _babel_runtime_corejs3_core_js_object_get_own_property_descriptor__WEBPACK_IMPORTED_MODULE_3___default()(prototype, py);
          if (descriptor) {
            Object.defineProperty(prototype, py, (0,_babel_runtime_corejs3_helpers_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, descriptor, {
              set: function set(value) {
                if (descriptor.set) {
                  var _context13;
                  ...
                  descriptor.set.apply(this, _babel_runtime_corejs3_core_js_instance_concat__WEBPACK_IMPORTED_MODULE_1___default()(_context13 = [convertUrl(value)]).call(_context13, args));
                }
              }
            }));
          }
...
function ap(proxyUrl, regExp) {
  var win = window || __webpack_require__.g || self || this || {};
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _amap_proxy__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./amap-proxy */ "./src/amap-proxy.js");
/*
 * @Author: Huangjs
 * @Date: 2021-10-10 15:07:28
 * @LastEditors: Huangjs
...
/* harmony default export */ __webpack_exports__["default"] = (_amap_proxy__WEBPACK_IMPORTED_MODULE_0__["default"]);
}();
/******/ 	return __webpack_exports__;
/******/ })()
;
});
//# sourceMappingURL=amap-proxy.js.map